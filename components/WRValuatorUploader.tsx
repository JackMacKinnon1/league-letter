    ...
    <section className="rounded-[2rem] border border-zinc-800 bg-zinc-900 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-400">
            Upload one season at a time. After each upload, the 5-year WR values
            are recalculated.
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950 p-4">
        ...
        <p className="mt-3 text-sm leading-7 text-zinc-400">
          Fantasy Points Data: TD, REC, YDS, TGT, TGT %, TPRR, 1Read %, YPRR,
          YPT, YPR, YPTOE, YAC/REC, YACO/REC, MTF/REC.
        </p>
        ...
        <p className="mt-2 text-sm leading-7 text-zinc-500">
          Age is supported if the Fantasy Points file has Age or AgeSeason. If
          no age exists, the age component is set to neutral.
        </p>
      </div>
    </section>
  )
